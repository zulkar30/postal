        ...
        <div class="content-wrapper">
            ...
            <div class="content-header row">
                <div class="content-header-left col-md-6 col-12 mb-2 breadcrumb-new">
                    <h3 class="content-header-title mb-0 d-inline-block">Lansia</h3>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-content collapse hide">
                                        <div class="card-body card-dashboard">
                                            ...
                                            <form class="form form-horizontal" action="{{ route('lansia.store') }}"
                                                                ...
                                                                <td class="text-center">
                                                                    @can('lansia_show')
                                                                        <a href="#mymodal"
                                                                            ...
                                                                            data-title="Lansia Detail" class="badge badge-info"
                                                                    ...
                                                                    @can('lansia_delete')
                                                                        <a href="#" class="badge badge-danger"
                                                                            ...
                                                                            onclick="deletelansia({{ $lansia_item->id }})"><svg
                                                                                xmlns="http://www.w3.org/2000/svg" width="20"
                                                                                height="20" viewBox="0 0 24 24"
                                                                                style="fill: rgb(255, 255, 255);transform: ;msFilter:;">
                                                                                <path
...
@push('after-script')
    ...
    <script>
        ...
        function deletelansia(lansiaId) {
            if (confirm('Anda yakin ingin menghapus lansia ini?')) {
                var form = document.createElement('form');
                form.action = '{{ route('lansia.destroy', '__id') }}'.replace('__id', lansiaId);
                form.method = 'POST';
