        ...
        <div class="content-wrapper">
            ...
            <div class="content-header row">
                <div class="content-header-left col-md-6 col-12 mb-2 breadcrumb-new">
                    <h3 class="content-header-title mb-0 d-inline-block">Jadwal</h3>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-content collapse hide">
                                        <div class="card-body card-dashboard">
                                            ...
                                            <form class="form form-horizontal" action="{{ route('jadwal.store') }}"
                                                ...
                                                <div class="form-body">
                                                    ...
                                                    <div class="form-group row">
                                                        <label class="col-md-3 label-control" for="jam">Jam
                                                            <code style="color:red;">required</code></label>
                                                        <div class="col-md-9 mx-auto">
                                                            <input type="time" id="jam" name="jam"
                                                                class="form-control" placeholder="Jam"
                                                                value="{{ old('jam') }}" autocomplete="off" required>
                                                    ...
                                                    <div class="form-group row">
                                                        <label class="col-md-3 label-control" for="lokasi">Lokasi
                                                            <code style="color:red;">required</code></label>
                                                        <div class="col-md-9 mx-auto">
                                                            <input type="text" id="lokasi" name="lokasi"
                                                                class="form-control" placeholder="Lokasi"
                                                                value="{{ old('lokasi') }}" autocomplete="off" required>
                                                    ...
                                                    <div class="form-group row">
                                                        <label class="col-md-3 label-control" for="kegiatan">Kegiatan
                                                            <code style="color:red;">required</code></label>
                                                        <div class="col-md-9 mx-auto">
                                                            <input type="text" id="kegiatan" name="kegiatan"
                                                                class="form-control" placeholder="Lokasi"
                                                                value="{{ old('kegiatan') }}" autocomplete="off" required>
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-header">
                                        <h4 class="card-title">Jadwal List</h4>
                                                                ...
                                                                <td class="text-center">
                                                                    {{-- @can('jadwal_show')
                                                                        <a href="#mymodal"
                                                                            ...
                                                                            data-title="Jadwal Detail" class="badge badge-info"
                                                                    ...
                                                                    @can('jadwal_delete')
                                                                        <a href="#" class="badge badge-danger"
                                                                            ...
                                                                            onclick="deletejadwal({{ $jadwal_item->id }})"><svg
                                                                                xmlns="http://www.w3.org/2000/svg" width="20"
                                                                                height="20" viewBox="0 0 24 24"
                                                                                style="fill: rgb(255, 255, 255);transform: ;msFilter:;">
                                                                                <path
    ...
    <script>
        ...
        function deletejadwal(jadwalId) {
            if (confirm('Anda yakin ingin menghapus jadwal ini?')) {
                ...
                form.action = '{{ route('jadwal.destroy', '__id') }}'.replace('__id', jadwalId);
                form.method = 'POST';
